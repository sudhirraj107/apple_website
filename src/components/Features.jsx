...
const Features = () => {
    ...
    useGSAP(()=> {
        ...
        animateWithGsap('.g_grow', {scsle:1,opacity:1,ease:'power1'},
            {scrub:5.5}
         );
                ...
                <div className='flex flex-col w-full relative'>
                    ...
                    <div className='feature-text-container'>
                        <div className='flex-1 flex-center'>
                            <p className='feature-text g_text'>iPhone pro is {' '}
                            ...
                            <div className='flex-1 flex-center'>
                            <p className='feature-text g_text'>Titanium has one of the strength-to-weight artios of any metal, making these our {' '}
